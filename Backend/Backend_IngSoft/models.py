...
class Configurazione(models.Model):
    ...
    fanali = models.ForeignKey(Optional, on_delete=CASCADE, related_name='fanali')
    finestrini = models.ForeignKey(Optional, on_delete=CASCADE, related_name='finestrini')
    scarico = models.ForeignKey(Optional, on_delete=CASCADE, related_name='scarico')
    sospensioni = models.ForeignKey(Optional, on_delete=CASCADE,
                                    related_name='sospensioni')
    sedili = models.ForeignKey(Optional, on_delete=CASCADE, related_name='sedili')
...
class Periodo(models.Model):
    ...
    anno = models.IntegerField(choices=year_choice(), default=current_year(),
